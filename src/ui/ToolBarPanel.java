...
public class ToolBarPanel {
  ...
  public ToolBarPanel(final MainWindow mainWindow) {
    ...
    /*
     * // Main menu final ToolItem itemMainMenu = new
     * ToolItem(toolbar,SWT.DROP_DOWN); itemMainMenu.setText("Main");
     * itemMainMenu.setToolTipText("Main program operations"); final Menu
     * mainDropDownMenu = new Menu(shell,SWT.POP_UP); new
     * MenuItem(mainDropDownMenu,SWT.PUSH).setText("Open"); new
     * MenuItem(mainDropDownMenu,SWT.PUSH).setText("Save"); new
     * MenuItem(mainDropDownMenu,SWT.PUSH).setText("Save As..."); new
     * MenuItem(mainDropDownMenu,SWT.PUSH).setText("Exit");
     * itemMainMenu.addListener(SWT.Selection, new
     * DropDownListener(itemMainMenu, mainDropDownMenu));
     * 
     * // Edit menu final ToolItem itemEditMenu = new
     * ToolItem(toolbar,SWT.DROP_DOWN); itemEditMenu.setText("Edit");
     * itemEditMenu.setToolTipText("Edit options"); final Menu editDropDownMenu
     * = new Menu(shell,SWT.POP_UP); new
     * MenuItem(editDropDownMenu,SWT.PUSH).setText("Undo"); new
     * MenuItem(editDropDownMenu,SWT.PUSH).setText("Redo"); new
     * MenuItem(editDropDownMenu,SWT.PUSH).setText("Find");
     * itemEditMenu.addListener(SWT.Selection, new
     * DropDownListener(itemEditMenu, editDropDownMenu));
     * 
     * // About menu final ToolItem itemAboutMenu = new
     * ToolItem(toolbar,SWT.DROP_DOWN); itemAboutMenu.setText("About");
     * itemAboutMenu.setToolTipText("About the creators"); final Menu
     * aboutDropDownMenu = new Menu(shell,SWT.POP_UP); new
     * MenuItem(aboutDropDownMenu,SWT.PUSH).setText("Credits"); new
     * MenuItem(aboutDropDownMenu,SWT.PUSH).setText("Help"); new
     * MenuItem(aboutDropDownMenu,SWT.PUSH).setText("Update");
     * itemAboutMenu.addListener(SWT.Selection, new
     * DropDownListener(itemAboutMenu, aboutDropDownMenu));
     */
    ...
    widgetItem.addListener(SWT.Selection, new LeftDropDownListener(widgetItem,
        widgetDropDown));
    toolbar.pack();
