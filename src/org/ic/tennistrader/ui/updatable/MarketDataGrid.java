...
public class MarketDataGrid extends MatchViewerWidget implements
	...
	private void init(String pl1Lastname, String pl2Lastname) {
		...
		backOR = createOddsLabel("Back", Colours.getBackColor(), headerData, SWT.LEFT, SWT.RIGHT);
		layOR = createOddsLabel("Lay", Colours.getLayColor(), headerData, SWT.RIGHT, SWT.LEFT);
	...
	private Label createOddsLabel(String string, Color color, GridData headerData, int or, int lab) {
		...
		this.getDisplay().asyncExec(new Runnable() {
			...
			public void run() {
				if (newData.getPl1Back() != null) {
					...
					updateOverround(backOR, p1BackButtons[2].getOdds(), p2BackButtons[2].getOdds());
					updateOverround(layOR, p1LayButtons[0].getOdds(), p2LayButtons[0].getOdds());
					double lpm1 = newData
