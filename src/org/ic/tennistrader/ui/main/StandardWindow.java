...
public class StandardWindow implements ApplicationWindow {
    ...
    public static void main(String [] args){
        ...
        ApplicationWindow mw = new StandardWindow(display);
        Shell s = mw.show();
        while (!s.isDisposed()){
    ...
    /* (non-Javadoc)
	 * @see org.ic.tennistrader.ui.ApplicationWindow#run(org.eclipse.swt.widgets.Display)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.ic.tennistrader.ui.ApplicationWindow#notifyLoadEvent(java.lang.String)
	 */
    @Override
