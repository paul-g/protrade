...
The choice for Java as a main programming language was based on:
\begin{itemize}
  \item team member's prior work experience - each team member was experienced with Java more than any other programming language
  \item good concurrency support
  \item good performance - ability to create native GUI components
...
Other languages were not considered due to lack of experience.
