...
public class BetManagerTest {
	...
	public void setUp() {
		...
		BetManager
				.setMatchMarketData(new ConcurrentHashMap<Match, VirtualBetMarketInfo>());
	}
	...
	public void testBetPlacing() {
		...
		for (int i = 0; i < 5; i++) {
			BetManager.placeBet(match, PlayerEnum.PLAYER1, BetTypeEnum.B, 2.5,
					10.0);
			assertEquals(0, BetManager.getMatchedBets().size());
	...
	public void testBetProfit() {
		...
		assertEquals(-10.0, BetManager.getBetProfit(bet, false),
				Math.pow(10, -5));
		...
		assertEquals(-15.0, BetManager.getBetProfit(bet, false),
				Math.pow(10, -5));
	}
	...
	public void testMatchedBet() {
		MOddsMarketData data = createMarket(PlayerEnum.PLAYER1, BetTypeEnum.B,
				2.5, 10.0);
		/*
		 * new MOddsMarketData(); ArrayList<Pair<Double, Double>> pl1Back = new
		 * ArrayList<Pair<Double, Double>>(); pl1Back.add(pair(2.5, 10.0));
	...
	public void testUpdatingMarketBackPlayerOne() {
		...
		BetManager.updateMarketAvailableMatches(match, data);
		BetManager
				.placeBet(match, PlayerEnum.PLAYER1, BetTypeEnum.B, 2.5, 20.0);
		assertEquals(0, BetManager.getMatchedBets().size());
		assertEquals(1, BetManager.getUnmatchedBets().size());
	...
	public void testUpdatingMarketBackPlayerTwo() {
		MOddsMarketData data = createMarket(PlayerEnum.PLAYER2, BetTypeEnum.B,
				2.5, 10.0);
		BetManager.updateMarketAvailableMatches(match, data);
		BetManager
				.placeBet(match, PlayerEnum.PLAYER2, BetTypeEnum.B, 2.5, 20.0);
		assertEquals(0, BetManager.getMatchedBets().size());
		assertEquals(1, BetManager.getUnmatchedBets().size());
	...
	public void testUpdatingMarketLayPlayerOne() {
		MOddsMarketData data = createMarket(PlayerEnum.PLAYER1, BetTypeEnum.L,
				2.5, 10.0);
		BetManager.updateMarketAvailableMatches(match, data);
		BetManager
				.placeBet(match, PlayerEnum.PLAYER1, BetTypeEnum.L, 2.5, 20.0);
		assertEquals(0, BetManager.getMatchedBets().size());
		assertEquals(1, BetManager.getUnmatchedBets().size());
	...
	public void testUpdatingMarketLayPlayerTwo() {
		MOddsMarketData data = createMarket(PlayerEnum.PLAYER2, BetTypeEnum.L,
				2.5, 10.0);
		BetManager.updateMarketAvailableMatches(match, data);
		BetManager
				.placeBet(match, PlayerEnum.PLAYER2, BetTypeEnum.L, 2.5, 20.0);
		assertEquals(0, BetManager.getMatchedBets().size());
		assertEquals(1, BetManager.getUnmatchedBets().size());
	...
	public void testPartlyMatchBet() {
		...
		BetManager.updateMarketAvailableMatches(match, data);
		BetManager
				.placeBet(match, PlayerEnum.PLAYER2, BetTypeEnum.L, 2.5, 30.0);
		assertEquals(0, BetManager.getMatchedBets().size());
		assertEquals(1, BetManager.getUnmatchedBets().size());
	...
	public void testUnmatchedBetMoreMatches() {
		...
		HistoricalMatch secondMatch = new HistoricalMatch(new Player("Rafael",
				"Nadal"), new Player("Roger", "Federer"));
		data = createMarket(PlayerEnum.PLAYER2, BetTypeEnum.L, 2.5, 30.0);
	...
	public void testMatchLiability() {
		...
		BetManager
				.placeBet(match, PlayerEnum.PLAYER1, BetTypeEnum.B, 2.5, 10.0);
		assertEquals(10.0, BetManager.getMatchLiability(match),
				Math.pow(10, -5));
		BetManager
				.placeBet(match, PlayerEnum.PLAYER1, BetTypeEnum.B, 2.5, 10.0);
		assertEquals(20.0, BetManager.getMatchLiability(match),
				Math.pow(10, -5));

		data = createMarket(PlayerEnum.PLAYER1, BetTypeEnum.L, 4.0, 50.0);
		BetManager.updateMarketAvailableMatches(match, data);
		BetManager
				.placeBet(match, PlayerEnum.PLAYER1, BetTypeEnum.L, 4.0, 10.0);
		assertEquals(30.0, BetManager.getMatchLiability(match),
				Math.pow(10, -5));
	}
	...
	public void testTotalLiability() {
		...
		HistoricalMatch newMatch = new HistoricalMatch(new Player(),
				new Player());
		data = createMarket(PlayerEnum.PLAYER1, BetTypeEnum.L, 4.0, 50.0);
	...
	private MOddsMarketData createMarket(PlayerEnum player,
			BetTypeEnum betType, double odds, double value) {
		MOddsMarketData data = new MOddsMarketData();
